...
Order_ID = 'ad30c4fe-885b-4b32-9de2-264eeb655d7f'
...
os.system('curl -H "%s" --request POST --data @data_hai.json http://13.40.67.209:5000/Anonymous/read>Log_file.json' % X_token)
