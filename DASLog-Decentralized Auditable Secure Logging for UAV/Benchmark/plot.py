...
plt.plot(xnew2, f_cubic2(xnew2), '--o', label='Simple-DASLog with tampered log(s)', linewidth=3)
plt.scatter(xnew2, f_cubic2(xnew2), s=100)
xnew5 = np.linspace(df5['C'].min(), df5['C'].max(), 8)
f_cubic5 = interp1d(df5['C'], df5['Bhc'], kind='cubic')
plt.plot(xnew5, f_cubic5(xnew5), '--^', label='Simple-DASLog', linewidth=3)
...
plt.plot(xnew6, f_cubic6(xnew6), '--P', label='DASLog', linewidth=3)
